...
covariance matrix. Another popular example is for example a mixed
model repeated measures (MMRM) model. See also the help page of the
neurodeg data set `?neurodeg`, for a different longitudinal example.

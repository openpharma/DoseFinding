...
# FIXME: DoseFinding::sigEmax is NaN for large dose & large h.
# nlminb acutally stumbles into those regions.
# More stable alternative implementation:
sigEmax_alt <- function(dose, e0, eMax, ed50, h) {
  e0 + eMax / (1 + exp(h * log(ed50 / dose)))
}

sigEmax_alt(10, 1, 5, 4, 10) == sigEmax(10, 1, 5, 4, 10)
sigEmax_alt(150, 1, 5, 4, 150)
sigEmax(150, 1, 5, 4, 150)

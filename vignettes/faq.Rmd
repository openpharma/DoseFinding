...
models can be utilized (see the help page of the neurodeg data set
`?neurodeg`).
...
asymptotic confidence intervals are not reliable.
...
adequate strategy for intercurrent events and missing data). This
model is then used to produce covariate adjusted estimates at the
...
be interpreted very cautiously, when no overall dose-response trend
has been established in the MCP step.

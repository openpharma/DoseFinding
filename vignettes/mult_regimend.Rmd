...
one common `e0`,
`(eMax, ed50)` for the o.d. regimen,
and `(eMax, ed50)` for the b.i.d. regimen.
...
that is detailed in the [basic usage vignette](2_analysis_normal.html#dose-response-estimation).
